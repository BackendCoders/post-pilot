    ...
    const pageResults = results.map((page) => {
      ...
      return {
        ...
        analysisData: {
          ...
          requestedUrl: page.requestedUrl || page.url || null,
          finalUrl: page.finalUrl || page.url || null,
          openGraph: page.openGraph || { title: null, description: null, image: null },
          twitterCard: page.twitterCard || { card: null, title: null, description: null, image: null },
          inlineScriptsCount: page.inlineScriptsCount || 0,
          inlineScriptsBytes: page.inlineScriptsBytes || 0,
          largestInlineScriptBytes: page.largestInlineScriptBytes || 0,
          inlineStylesCount: page.inlineStylesCount || 0,
          inlineStylesBytes: page.inlineStylesBytes || 0,
          largestInlineStyleBytes: page.largestInlineStyleBytes || 0,
          totalJsCount: page.totalJsCount || 0,
          minifiedJsCount: page.minifiedJsCount || 0,
          totalCssCount: page.totalCssCount || 0,
          minifiedCssCount: page.minifiedCssCount || 0,
          jsonLdBlocksCount: page.jsonLdBlocksCount || 0,
          jsonLdItemsCount: page.jsonLdItemsCount || 0,
          jsonLdTypes: page.jsonLdTypes || [],
          schemaErrors: page.schemaErrors || [],
          hasSchemaMarkup: page.hasSchemaMarkup || false,
          hasBreadcrumbSchema: page.hasBreadcrumbSchema || false,
          hasBreadcrumbLinks: page.hasBreadcrumbLinks || false,
    ...
    if (existingAnalysis) {
      ...
      if (pageResult) {
        pageResult.analysisData = {
          ...
          requestedUrl: analysisData.requestedUrl || analysisData.url || null,
          finalUrl: analysisData.finalUrl || analysisData.url || null,
          openGraph: analysisData.openGraph || { title: null, description: null, image: null },
          twitterCard: analysisData.twitterCard || { card: null, title: null, description: null, image: null },
          inlineScriptsCount: analysisData.inlineScriptsCount || 0,
          inlineScriptsBytes: analysisData.inlineScriptsBytes || 0,
          largestInlineScriptBytes: analysisData.largestInlineScriptBytes || 0,
          inlineStylesCount: analysisData.inlineStylesCount || 0,
          inlineStylesBytes: analysisData.inlineStylesBytes || 0,
          largestInlineStyleBytes: analysisData.largestInlineStyleBytes || 0,
          totalJsCount: analysisData.totalJsCount || 0,
          minifiedJsCount: analysisData.minifiedJsCount || 0,
          totalCssCount: analysisData.totalCssCount || 0,
          minifiedCssCount: analysisData.minifiedCssCount || 0,
          jsonLdBlocksCount: analysisData.jsonLdBlocksCount || 0,
          jsonLdItemsCount: analysisData.jsonLdItemsCount || 0,
          jsonLdTypes: analysisData.jsonLdTypes || [],
          schemaErrors: analysisData.schemaErrors || [],
          hasSchemaMarkup: analysisData.hasSchemaMarkup || false,
          hasBreadcrumbSchema: analysisData.hasBreadcrumbSchema || false,
          hasBreadcrumbLinks: analysisData.hasBreadcrumbLinks || false,
